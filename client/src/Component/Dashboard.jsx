...
const Dashboard = () => {
  ...
  const fetchUserCount = async () => {
    try {
      ...
      console.log(res);
      setUserCount(res.data.user || res.data); 
      setProductCount(res.data.product || res.data);
      setCategoryCount(res.data.category || res.data);
    } catch (error) {
      ...
      <div class="container-fluid py-2">
        <div class="row">
          ...
          <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card" onClick={() => navigate("/userList")} style={{ cursor: 'pointer' }}>
          ...
          <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card" onClick={() => navigate("/productList")} style={{ cursor: 'pointer' }}>
              <div class="card-header p-2 ps-3">
                <div class="d-flex justify-content-between">
                  <div>
                    <p class="text-sm mb-0 text-capitalize">Product Count</p>
          ...
          <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card" onClick={() => navigate("/categoryList")} style={{ cursor: 'pointer' }}>
              <div class="card-header p-2 ps-3">
                <div class="d-flex justify-content-between">
                  <div>
                    <p class="text-sm mb-0 text-capitalize">Category Count</p>
